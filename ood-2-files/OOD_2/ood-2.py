...
budget=30
num_epochs = int(10)
split_cfg = {'num_cls_idc':11, 'per_idc_train':10, 'per_idc_val':10, 'per_idc_lake':150, 'per_ood_train':0, 'per_ood_val':0, 'per_ood_lake':8000}

initModelPath = "/mnt/data2/akshit/Organ/OOD_2/weights/" + data_name + "_" + feature + "_" + model_name + "_" + str(learning_rate) + "_" + str(split_cfg["per_idc_train"]) + "_" + str(split_cfg["per_idc_val"]) + "_" + str(split_cfg["num_cls_idc"])
